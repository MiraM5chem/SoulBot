...
support_data = {
    ...
    "anxiety": {
        ...
        "tips": [
            ...
            "• Пройдись по комнате и осмотрись вокруг, чтобы почувствовать себя в безопасности.",
            "• Сделай несколько глубоких вдохов и выдохов, сосредоточься на дыхании."
        ],
    ...
    "motivation": {
        ...
        "tips": [
            ...
            "• Разбей свою задачу на маленькие шаги и начни с самого простого.",
            "• Вспомни, почему ты начал — это вернёт твой фокус и силы."
        ],
    ...
    "confidence": {
        ...
        "tips": [
            ...
            "• Прими позу уверенности: расправь плечи, выпрями спину.",
            "• Запиши 5 своих сильных сторон и напомни себе, в чём ты силён."
        ],
